...
export class sys_user_post {
  ...
  @ManyToOne(() => sys_post, sys_post => sys_post.sys_user_posts, {
    onDelete: 'NO ACTION',
    onUpdate: 'NO ACTION',
    lazy: true,
  })
  @JoinColumn([{ name: 'post_id', referencedColumnName: 'id' }])
  post_: Promise<sys_post>

  @ManyToOne(() => sys_user, sys_user => sys_user.sys_user_posts, {
    onDelete: 'NO ACTION',
    onUpdate: 'NO ACTION',
    lazy: true,
  })
